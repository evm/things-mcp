...
This is a Model Context Protocol (MCP) server that bridges Codex Desktop with the Things 3 task management app on macOS. The architecture consists of:
...
- All tools return formatted text strings suitable for Codex
